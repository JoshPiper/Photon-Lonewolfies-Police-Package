...
local name = "Internet LW Interior Lightbar %s"
...
TMPL.Deprecated = "Use the core component '%s'."
...
local function build(id, color1, color2, skin, alternater, mainHasTraffic)
	...
	CPMT.Deprecated = string.format(CPMT.Deprecated, string.format(name:sub(10), id))
	EMVU:AddAutoComponent(CPMT, Format(name, id))
end

build("Clear/Red", "_1", "RED", 0, ALT_NONE)
build("Blue/Red", "BLUE", "RED", 1, ALT_NONE)
build("Red", "D_RED", "D_RED", 2, ALT_CAN)
build("Amber", "AMBER", "AMBER", 3, ALT_CAN, true)
build("Clear", "_1", "_2", 4, ALT_CAN, true)
build("Blue/Red Alt", "BLUE", "RED", 5, ALT_MUST)
build("Clear/Red Alt", "RED", "_1", 6, ALT_MUST)
build("Clear/Blue Alt", "BLUE", "_1", 8, ALT_MUST)